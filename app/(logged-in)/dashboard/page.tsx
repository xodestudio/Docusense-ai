...
export default async function DashboardPage() {
  ...
  // 2. 📊 REAL Analytics Calculation (with Fallback)
  const totalDocs = summaries.length;

  const totalWords = summaries.reduce((acc, curr) => {
    // Agar DB mein word_count hai to wo lo, warna Summary Text words * 5 (Approx ratio)
  ...
  // Formula: Words / 200 = Original Time.
  // Hum assume karte hain Summary ne 80% time bachaya.
